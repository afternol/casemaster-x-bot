...
追加条件:
- 絵文字を2〜3個使う
- フレームワークの使い方・ケース面接でいつ使うかを具体的に解説する
- 「〇〇のケースが出たら→まず□□で分解」のような実践的な使い方を盛り込む
- 構造例：【導入1行】→【解説2〜3行（箇条書き可）】→【使いどころ1行】→【ハッシュタグ】
...
- NGパターンとOKパターンを明示的に対比する（例：❌ 〜 → ✅ 〜）
- 即実践できる内容（抽象論は避ける）
- 繰り返し練習・毎日の積み上げの重要性を自然に示唆する
- 絵文字2〜3個
- 構造例：【フック1行】→【NG描写1〜2行】→【OK改善1〜2行】→【まとめ1行】→【ハッシュタグ】
...
- 「【{term}】」で始める
- 本質を一言でつく解説（1〜2行）
- ケース面接での具体的な使いどころ（1〜2行）
- 使う際の注意点や落とし穴（1行）
- 絵文字1〜2個
- 構造例：【用語タイトル】→【本質解説】→【使いどころ】→【注意点】→【ハッシュタグ】
- ハッシュタグは「#コンサル用語」「#ケース面接」のどちらか1つ"""
    return _call_claude(prompt)
...
{FORMAT_RULES}
追加条件:
- 「〇〇してしまいがち」「多くの人がやるミス」などの共感できる入り口で始める
- ❌ NGパターンを具体的に描写（1〜2行）
- ↓ なぜNGか（1行）
- ✅ 具体的な改善策（1〜2行）
- 絵文字2〜3個
- 構造例：【フック1行】→【❌NG描写】→【なぜNG】→【✅改善策】→【ハッシュタグ】
...
{FORMAT_RULES}
追加条件:
- 「{industry}のケースが出たら」で始める
- 業界特有のKPIや収益構造の論点を箇条書きで2〜3個具体的に挙げる
- 「このフレームで分解するとスムーズ」など分析の切り口も添える
- 絵文字2〜3個
- 構造例：【導入1行】→【論点箇条書き2〜3項目】→【フレーム1行】→【ハッシュタグ】
- ハッシュタグは「#ケース面接」「#業界研究」のどちらか1つ"""
    return _call_claude(prompt)
...
追加条件:
- 引用を冒頭に「」で目立たせて置く
- ケース面接・コンサル思考との接続を具体的に解説（2〜3行）
- 実践方法や日々の心がけまで踏み込む（1〜2行）
- 絵文字1〜2個
- 構造例：【引用1〜2行】→【接続解説2〜3行】→【実践ポイント1行】→【ハッシュタグ】
- ハッシュタグは「#ケース面接」「#名言」のどちらか1つ"""
    return _call_claude(prompt)
